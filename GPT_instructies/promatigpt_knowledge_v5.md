...
## 20. Architectuurregel v5

PromatiGPT Knowledge v5 is een inhoudelijk interpretatiekader.
...
Versie: PromatiGPT Knowledge v5

Belangrijkste wijzigingen ten opzichte van v4:
- centrale routing via promati_orchestrator_ask;
- oude directe Action-verwijzingen verwijderd;
- expliciet onderscheid tussen actuele data en knowledge;
- semantic/object-grounding regel toegevoegd;
- FACT / INFERENCE / HYPOTHESIS / RECOMMENDATION toegevoegd;
- diagnostische datakwaliteitsclassificaties toegevoegd;
- automatische datacorrectie expliciet uitgesloten.
