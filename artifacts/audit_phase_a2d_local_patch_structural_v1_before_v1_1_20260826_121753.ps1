...
# ============================================================
# MODELS — positive structural contract
# ============================================================
...
# ============================================================
# MODELS — normalize A2d away and require exact A2c AST
# ============================================================
...
# ============================================================
# UNDERSTANDING — frozen A2c activation exact
# ============================================================
...
# ============================================================
# UNDERSTANDING — positive A2d structure
# ============================================================
...
# ============================================================
# UNDERSTANDING — exact normalization back to frozen A2c
# ============================================================
...
for node in norm_understand.body:
    ...
    if isinstance(node, ast.If):
        ...
        if 'entities["band_code"] = band' in body_text:
