...
DEFAULT_FOLDER = r"C:\ai-platform\Rag\org"
...
def build_doc_id(path: Path) -> str:
    """
    Voorbeeld:
    rag_org_info_mailbox.md -> rag_org_info_mailbox
    """
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Importeer org RAG markdownbestanden naar Promati RAG API."
    )
    parser.add_argument(
        "--folder",
    ...
    if not files:
        print(f"Geen .md bestanden gevonden in: {folder}")
        return 1
