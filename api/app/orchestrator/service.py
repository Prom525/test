...
from app.orchestrator.serialization_stage import (
...
def _build_user_answer(
    ...
    if asset_result is not None:
        ...
        if (
            ...
            if lifecycle_stage.answer is not None:
        ...
        if (
            ...
            if maintenance_positions_stage.answer is not None:
    ...
    for item in results:
        ...
        if action == "diagnostics_assistant":
            return run_diagnostics_answer_stage(specialist_result)
        ...
        if (
            ...
            org_answer_stage_result = run_org_answer_stage(specialist_result)

            if org_answer_stage_result.answer is not None:
                return org_answer_stage_result.answer
    ...
    try:
        ...
        if phase_c_entry is not None:
            ...
            product_family_coverage = (
                product_family_recovery_stage.product_family_coverage
            )
            product_family_recovery = (
                product_family_recovery_stage.product_family_recovery
            )
            working_evidence_items = (
            ...
            phase_c_evidence_pipeline_stage = (
                run_phase_c_evidence_pipeline_stage(
                    requirement_set,
                    ...
                    evidence_pipeline_to_dict=_evidence_pipeline_to_dict,
                )
            )
            evidence_pipeline = (
                phase_c_evidence_pipeline_stage.evidence_pipeline
            )
