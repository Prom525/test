...
SPECIALIST_CONTRACTS: dict[str, SpecialistContract] = {
    ...
    "analysis_assistant": SpecialistContract(
        ...
        accepted_input_fields=(
            "vraag",
            # PROMATI_ANALYSIS_MODE_ACCEPTED_INPUT_V1
            "mode",
            "lijn_code",
            "date_from",
            "date_to",
        ...
        status_contract_state="STATIC_OBSERVED",
        status_map={
            # Successful analysis responses such as
            # inspection_summary, lifecycle and
            # band_deep_analysis are historically statusless.
            "__missing__": ExecutionOutcome.SUCCESS,
