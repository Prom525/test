...
def _infer_result_count(
    ...
    # PROMATI_RESULT_COUNT_RESULTAAT_V1
    # PROMATI assistant-contracten kunnen een lijst
    # onder de Nederlandse sleutel "resultaat" leveren.
    # Dit is uitsluitend observability; acceptance en
    # inhoudelijke semantiek blijven ongemoeid.
    for key in (
        "results",
        "rows",
        "items",
...
def execute_plan(
    ...
    shadow_observer: Callable[[ExecutionResult], None] | None = None,
) -> tuple[
    list[dict[str, Any]],
    OrchestratorTrace,
]:
